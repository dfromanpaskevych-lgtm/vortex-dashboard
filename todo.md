...
- [ ] Авто-ретрай до 3 спроб (замість 1) при помилці чанку
- [ ] Продовження чанків після ретраю — retryChunk має продовжувати решту run
- [x] Валідація покриття періоду після завершення всіх чанків
